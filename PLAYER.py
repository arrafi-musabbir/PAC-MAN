...
class Player:
    ...
    def update(self):
        ...
        print(self.pix_pos)
        print("gd", self.Game.arr[int(self.pix_pos.x-38)][int(self.pix_pos.y-15)])
        print("one")
    ...
    def can_move(self):
        if self.Game.arr[int(self.pix_pos.x-38)][int(self.pix_pos.y-15)] == 0:
            return False
        else:
            return True
